...
public class PDFComplexInvoiceBuilderTest {

	private PDFComplexInvoiceBuilder builderUnderTest;
	
	@BeforeEach
	public void setUp() {
		builderUnderTest = new PDFComplexInvoiceBuilder();
		assertNotNull(builderUnderTest);
	}
	...
	public void testCreateInvoicePdfThrowException() {
		assertThrows(PDFComplexInvoiceBuilderException.class, () -> builderUnderTest.build());
	}
	
	@Test
	public void testCreateInvoicePdfSuccessful() throws IOException {
		byte[] invoice = builderUnderTest.invoice(createInvoice()).build();
	}
